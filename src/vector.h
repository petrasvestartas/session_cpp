...
public:
    ...
    /// Return the unit area-weighted normal of a closed polyline by Newell's method.
    static Vector average_normal_polyline(const Polyline& polyline);
    ...
    session_proto::Vector to_proto() const;

    /// Construct from the protobuf message.
    static Vector from_proto(const session_proto::Vector& proto);
