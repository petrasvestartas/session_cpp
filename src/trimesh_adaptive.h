...
public:
    explicit TrimeshAdaptive(const NurbsSurface& surface);

    TrimeshAdaptive& set_max_angle(double degrees);
    TrimeshAdaptive& set_max_edge_length(double length);
    TrimeshAdaptive& set_min_edge_length(double length);
    TrimeshAdaptive& set_max_chord_height(double height);
