...
public:
    ...
    static constexpr double ZERO_TOLERANCE = 1e-12; // Used heavily by algorithms; do not change.
...
class ToleranceGuard {
    Tolerance* _target; // Guarded tolerance.
    Tolerance _saved; // Settings restored on destruction.
