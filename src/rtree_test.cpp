...
MINI_TEST("RTree", "Search Hit") {
    ...
    double q_min[3] = {1, 1, 1}, q_max[3] = {3, 3, 3};
    int found = -1;
    int hits = t.search(q_min, q_max, [&](int data) -> bool {
        found = data;
        return true;
    });
...
MINI_TEST("RTree", "Search Count") {
    ...
    double a1[3] = {2, 2, 2}, b1[3] = {3, 3, 3};
    t.insert(a1, b1, 1);
    double a2[3] = {3, 3, 3}, b2[3] = {4, 4, 4};
    t.insert(a2, b2, 2);
    double a3[3] = {10, 0, 0}, b3[3] = {11, 1, 1};
    t.insert(a3, b3, 3);
    double a4[3] = {0, 10, 0}, b4[3] = {1, 11, 1};
    t.insert(a4, b4, 4);
...
MINI_TEST("RTree", "Search 100 Boxes") {
    ...
    auto add = [&](double x0, double y0, double z0, double x1, double y1, double z1) {
        double mn[3] = {x0, y0, z0};
        double mx[3] = {x1, y1, z1};
        t.insert(mn, mx, id++);
    };
    ...
    double q_min[3] = {-60, -60, -60}, q_max[3] = {60, 60, 60};
