...
MINI_TEST("RemeshCDT", "Triangulate") {
    ...
    const std::vector<std::array<int, 3>> tris = RemeshCDT::triangulate({border, hole});
    std::vector<Point> flat;

    for (const Point& p : border.get_points())
        flat.push_back(p);
...
MINI_TEST("RemeshCDT", "Irregular Tilted Polyline") {
    ...
    const std::vector<Point> border = {
        ...
        Point(142.118715, 19.142866, 6.187686),   Point(141.57586, 17.857892, 0.253509),
        Point(140.11301, 18.526023, 3.339026),    Point(141.21524, 18.751613, 4.38083),
        Point(141.292725, 18.989286, 5.478431),   Point(139.566886, 19.055145, 5.78258),
        Point(138.763256, 18.580689, 3.59148),    Point(139.310849, 18.055272, 1.165039),
        Point(140.386846, 17.829745, 0.123525),   Point(140.874682, 17.186517, -2.846986),
        Point(142.977469, 16.726916, -4.969483),  Point(144.463527, 17.732299, -0.326495),
        Point(144.003555, 19.468828, 7.693018),   Point(133.951268, 20.010289, 10.193557),
        Point(143.92422, 20.548103, 12.677251),   Point(134.28842, 20.656763, 13.179053),
        Point(141.475986, 21.027044, 14.889059),  Point(148.395425, 21.092848, 15.192952),
        Point(146.816239, 20.209864, 11.115218),  Point(140.129758, 20.039236, 10.327236),
        Point(145.879946, 19.943669, 9.885895),   Point(146.207165, 18.815694, 4.676763),
        Point(149.810987, 21.502249, 17.083618),  Point(123.62156, 21.64297, 17.733487),
        Point(143.846461, 21.388459, 16.558122),  Point(123.531701, 20.756807, 13.641072),
        Point(131.906468, 20.861163, 14.123002),  Point(134.607416, 15.741609, -9.519754),
        Point(131.232551, 20.580328, 12.826068),  Point(122.959207, 20.008058, 10.183251),
        Point(129.590699, 18.785461, 4.537144),   Point(122.199489, 18.387709, 2.700273),
        Point(127.811443, 17.061665, -3.423569),  Point(132.763864, 14.563498, -14.960425),
        Point(137.425771, 15.246311, -11.807104), Point(133.976431, 19.415144, 7.445098),
        Point(141.147246, 14.792123, -13.904602), Point(134.321155, 13.729688, -18.811062),
...
MINI_TEST("RemeshCDT", "Irregular Tilted Polyline With Holes") {
    ...
    const std::vector<Point> border = {
        ...
        Point(82.6268, 17.180658, 0),    Point(83.346466, 22.810648, 0),  Point(80.646064, 27.128804, 0),
        Point(75.409533, 25.864862, 0),  Point(72.096289, 20.679753, 0),  Point(69.174993, 24.651843, 0),
        Point(73.459453, 30.365867, 0),  Point(78.285356, 32.047254, 0),  Point(84.294064, 31.313912, 0),
        Point(88.751527, 27.70307, 0),   Point(89.863118, 24.247859, 0),  Point(86.375694, 25.536811, 0),
        Point(85.671769, 28.704182, 0),  Point(83.931992, 29.140561, 0),  Point(83.87182, 26.993861, 0),
        Point(85.013894, 23.331116, 0),  Point(86.696592, 22.050319, 0),  Point(91.11007, 21.775838, 0),
        Point(93.068864, 24.22017, 0),   Point(90.710749, 28.565741, 0),  Point(91.638895, 29.907121, 0),
        Point(98.350352, 28.577586, 0),  Point(97.932933, 19.2177, 0),    Point(92.735476, 16.088655, 0),
        Point(88.933069, 18.173691, 0),  Point(87.14089, 18.175371, 0),   Point(88.303603, 12.293181, 0),
        Point(95.930447, 12.110783, 0),  Point(99.851107, 14.725665, 0),  Point(100.978975, 20.024267, 0),
        Point(102.243884, 24.855315, 0), Point(107.033349, 22.799502, 0), Point(106.609681, 11.898217, 0),
        Point(103.249112, 7.789628, 0),  Point(96.095448, 7.274641, 0),   Point(89.385773, 5.965419, 0),
        Point(96.860717, 2.216133, 0),   Point(100.861767, 4.379475, 0),  Point(101.881544, -0.42956, 0),
        Point(97.45084, -3.301412, 0),   Point(91.973637, -1.202488, 0),  Point(85.52513, 1.867323, 0),
        Point(84.223176, 6.692841, 0),   Point(89.798972, 8.864768, 0),   Point(95.492277, 9.295981, 0),
        Point(99.888391, 10.064787, 0),  Point(103.261854, 11.705226, 0), Point(103.779131, 19.764949, 0),
        Point(102.711068, 14.994661, 0), Point(99.443654, 12.155559, 0),  Point(97.732698, 11.322088, 0),
        Point(90.50953, 9.911877, 0),    Point(85.903966, 9.907526, 0),   Point(84.501578, 11.767742, 0),
