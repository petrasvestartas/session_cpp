...
inline auto vformat(text_style ts, string_view fmt,
 ...
 */
template <typename... T>
inline auto format(text_style ts, format_string<T...> fmt,
                   T &&...args) -> std::string {
...
auto vformat_to(OutputIt out, text_style ts, string_view fmt,
