...
// Constructors
// ═══════════════════════════════════════════════════════════════════════════
Color::Color(float r, float g, float b, float a, std::string name)
    : name(std::move(name)),
...
Color::Color(const Color& other) : name(other.name), r(other.r), g(other.g), b(other.b), a(other.a) {}
...
// Accessors
// ═══════════════════════════════════════════════════════════════════════════
const std::string& Color::guid() const {
