...
// Ported from wood_joint_lib.cpp and wood_joint.cpp.
// ───────────────────────────────────────────────────────────────────────────
...
// joint name id=10). Wood's annen test sets JOINTS_PARAMETERS_AND_TYPES[1*3+2]=10
// which selects this fixed-geometry variant rather than the parametric ss_e_op_1.
// Verbatim port of wood_joint_lib.cpp:1577-1606.
...
// ss_e_op_1: side-to-side out-of-plane finger joint (type=11).
// Creates parametric geometry in the [-0.5, 0.5]³ unit cube.
// Fills joint.m_outlines and joint.f_outlines.
...
// ts_e_p_3: top-to-side parametric tenon-mortise (type=20, default for annen).
...
// Ported from wood_joint_lib.cpp:3713-3935.
// ts_e_p_0: top-to-side HARDCODED 3-finger tenon-mortise (type 20, joint
// name id=20). Wood annen sets JOINTS_PARAMETERS_AND_TYPES[2*3+2]=20 which
// selects this fixed-geometry variant rather than the parametric ts_e_p_3.
// Verbatim port of wood_joint_lib.cpp:3527-3564.
//
