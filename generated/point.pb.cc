...
PROTOBUF_CONSTINIT ::google::protobuf::internal::ReflectionData
    file_reflection_data[] = {
        // ::session_proto::Point
        {&::_pbi::kDescriptorMethods, &::descriptor_table_point_2eproto, /* tracker*/ nullptr,},
};
}  // namespace
#endif
...
constexpr auto Point::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(Point), alignof(Point));
}
constexpr auto Point::InternalGenerateClassData_(
  ...
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          ...
          &Point::MergeImpl,
          Super_::GetNewImpl<Point>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
          &Point::SharedDtor,
          Super_::GetClearImpl<Point>(), &Point::ByteSizeLong,
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : Super_(arena, Point_get_class_data()) {
...
Point::Point(
  ...
  _impl_.pointcolor_ = (CheckHasBit(cached_has_bits, 0x00000004U))
                 ? Super_::CopyConstruct(arena, *from._impl_.pointcolor_)
                 : nullptr;
...
PROTOBUF_NOINLINE void Point::Clear() {
  ...
  if (BatchCheckHasBit(cached_has_bits, 0x00000007U)) {
    ...
    if (CheckHasBit(cached_has_bits, 0x00000004U)) {
      ABSL_DCHECK(this_._impl_.pointcolor_ != nullptr);
      this_._impl_.pointcolor_->Clear();
    }
  }
  ...
  if (BatchCheckHasBit(cached_has_bits, 0x0000007fU)) {
    ...
    if (CheckHasBit(cached_has_bits, 0x00000004U)) {
      ...
      if (_this->_impl_.pointcolor_ == nullptr) {
        _this->_impl_.pointcolor_ = Super_::CopyConstruct(arena, *from._impl_.pointcolor_);
      } else {
