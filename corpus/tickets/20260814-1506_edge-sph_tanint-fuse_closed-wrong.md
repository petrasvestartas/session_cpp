# edge/sph_tanint/fuse — closed-wrong (regression)
...
```bash
env SESSION_EDGE=1 SESSION_NO_ROT=1 SESSION_OP=fuse ./build/main_7 'sph tanint'
```
...
Battery row: `sph tanint fuse |      0.0000     65.4498  1.00e+00 |    1     1 | 1 |     1272 | FAIL`
