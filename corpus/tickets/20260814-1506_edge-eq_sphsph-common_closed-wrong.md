# edge/eq_sphsph/common — closed-wrong (regression)
...
```bash
env SESSION_EDGE=1 SESSION_NO_ROT=1 SESSION_OP=common ./build/main_7 'eq sphsph'
```
...
Battery row: `eq sphsph common |      0.0000     65.4498  1.00e+00 |    1     1 | 1 |     1199 | FAIL`
