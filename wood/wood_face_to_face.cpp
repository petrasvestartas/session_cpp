...
// Implementations of build_wood_element and face_to_face_wood declared in
// wood_face_to_face.h.  No file I/O: both functions operate purely on
// geometry data passed by the caller.
...
WoodElement build_wood_element(std::vector<Point> pp0, std::vector<Point> pp1) {
    WoodElement el;
