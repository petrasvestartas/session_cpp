...
// Forward declaration (ss_e_op_5 calls ss_e_op_4 which is defined later)
static void ss_e_op_4(WoodJoint& joint, double t, bool chamfer, bool female_modify_outline,
                       double x0, double x1, double y0, double y1, double z_ext0, double z_ext1);
